...
--------------------------------------------------------
--  DDL for Table DM_ARGUMENTS
--------------------------------------------------------

  CREATE TABLE "C##DB_DM"."DM_ARGUMENTS" 
   (	"ARG_ID" VARCHAR2(50 BYTE), 
	"ARG_KEY" VARCHAR2(32 BYTE), 
	"ARG_VAL1" VARCHAR2(20 BYTE), 
	"ARG_VAL2" VARCHAR2(20 BYTE), 
	"ARG_VAL3" VARCHAR2(20 BYTE), 
	"ARG_VAL4" VARCHAR2(20 BYTE), 
	"ARG_VAL5" VARCHAR2(20 BYTE), 
	"ARG_VAL6" VARCHAR2(20 BYTE), 
	"ARG_VAL7" VARCHAR2(20 BYTE), 
	"ARG_VAL8" VARCHAR2(20 BYTE), 
	"ARG_VAL9" VARCHAR2(20 BYTE), 
	"ARG_DESC" VARCHAR2(100 BYTE), 
	"STATUS" CHAR(1 BYTE) DEFAULT '1'
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;
   ...
   COMMENT ON TABLE "C##DB_DM"."DM_ARGUMENTS"  IS '参数表';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "C##DB_DM"."DM_MENU" 
   (	"MENU_ID" VARCHAR2(50 BYTE), 
	...
	"HASCHILDREN" CHAR(1 BYTE) DEFAULT '0', 
	"STATE" CHAR(1 BYTE) DEFAULT '0', 
	"IS_DEL" CHAR(1 BYTE) DEFAULT '0', 
	"IS_EDIT" CHAR(1 BYTE) DEFAULT '0', 
	"STATUS" CHAR(1 BYTE) DEFAULT '1', 
	"SORT" NUMBER(5,0)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "C##DB_DM"."DM_MENU"."OPEN_TYPE" IS '0无操作1本页打开2子页面打开（tab或iframe等）3打开新页面';
...
REM INSERTING into C##DB_DM.DM_ARGUMENTS
SET DEFINE OFF;
...
SET DEFINE OFF;
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('102','1','用户管理',null,'1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('103','1','角色管理',null,'1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('101','1','菜单管理',null,'1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('104','1','系统日志',null,'1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('105','1','应用管理',null,'1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('106','1','代码字典',null,'1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('107','1','参数表',null,'1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('108','1','卡片类型',null,'1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('201','2','用户日志',null,'1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('110','1','行业代码',null,'1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('109','1','商品代码','/fragment/spfl.html','1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('112','1','国家代码','/fragment/gjdq.html','1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('111','1','地区代码',null,'1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('113','1','库表一览',null,'1','0','0','0','0','1',null);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('1','0','系统',null,'0','1','0','0','0','1',1);
Insert into C##DB_DM.DM_MENU (MENU_ID,PARENT_ID,MENU_NAME,URL,OPEN_TYPE,HASCHILDREN,STATE,IS_DEL,IS_EDIT,STATUS,SORT) values ('2','0','用户',null,'0','1','0','0','0','1',2);
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index DM_ARGUMENTS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "C##DB_DM"."DM_ARGUMENTS_PK" ON "C##DB_DM"."DM_ARGUMENTS" ("ARG_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  Constraints for Table DM_ARGUMENTS
--------------------------------------------------------

  ALTER TABLE "C##DB_DM"."DM_ARGUMENTS" MODIFY ("ARG_ID" NOT NULL ENABLE);
  ALTER TABLE "C##DB_DM"."DM_ARGUMENTS" MODIFY ("ARG_KEY" NOT NULL ENABLE);
  ALTER TABLE "C##DB_DM"."DM_ARGUMENTS" MODIFY ("STATUS" NOT NULL ENABLE);
  ALTER TABLE "C##DB_DM"."DM_ARGUMENTS" ADD CONSTRAINT "DM_ARGUMENTS_PK" PRIMARY KEY ("ARG_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##DB_DM"."DM_MENU" MODIFY ("STATE" NOT NULL ENABLE);
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "C##DB_DM"."DM_MENU" MODIFY ("IS_DEL" NOT NULL ENABLE);
  ALTER TABLE "C##DB_DM"."DM_MENU" MODIFY ("IS_EDIT" NOT NULL ENABLE);
  ALTER TABLE "C##DB_DM"."DM_MENU" MODIFY ("HASCHILDREN" NOT NULL ENABLE);
--------------------------------------------------------
